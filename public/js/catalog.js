...
$(document).ready(function () {
    ...
    function filter_product(event) {
        function update_filter(cat_id){
            let filters = [];
            let prod_list=$('.main_products[data-cat_id='+cat_id+']').children('.product_list');
            ...
            $.ajax({
                ...
                success: function (data) {
                    prod_list.children('.main_prod').hide()
                    data.products.forEach(function(item, i) {
                        prod_list.find('[data-product_id=' + item + ']').show();
