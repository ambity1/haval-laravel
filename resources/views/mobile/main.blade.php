...
<main>
    @include('components.mobile.slider')
    @include('components.mobile.models')
    @include('components.mobile.specials')
    @include('components.mobile.offer1')
    @include('components.mobile.general.pageChange')
    @include('components.mobile.offer2')
    @include('components.mobile.about')
    @include('components.mobile.video')
    @include('components.mobile.service')
    @include('components.mobile.reviewsWrap')
    @include('components.mobile.general.news')
    @include('components.mobile.offer3')
    ...
    <script>
        ...
        models.on('slideChange', function () {
            const pagination = document.querySelector('.models .paginationWrap');
            const activeBullet = pagination.querySelector('.swiper-pagination-bullet-active');
            if (activeBullet.offsetLeft > pagination.offsetWidth * .7 || activeBullet.offsetLeft < pagination.scrollLeft) {
                pagination.scrollTo(activeBullet.offsetLeft, 0);
            }
        });
    </script>
    <script>
...
@include('components.mobile.textBanner')
